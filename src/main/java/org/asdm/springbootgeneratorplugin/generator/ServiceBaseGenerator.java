...
public class ServiceBaseGenerator extends BasicGenerator {
    ...
    public ServiceBaseGenerator(final GeneratorOptions generatorOptions, final MetaEntity metaEntity, final String outputPath) {
    ...
    public void generate() throws IOException {
        ...
        try {
            final String filename = this.metaEntity.getName() + "ServiceBase";
