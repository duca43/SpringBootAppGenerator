...
public class ServiceImplGenerator extends BasicGenerator {
    ...
    public ServiceImplGenerator(final GeneratorOptions generatorOptions, final MetaEntity metaEntity, final String outputPath) {
    ...
    public void generate() throws IOException {
        ...
        try {
            final String filename = this.metaEntity.getName() + "ServiceImpl";
