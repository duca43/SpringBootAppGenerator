...
public class NoEntityFoundExceptionGenerator extends BasicGenerator {
    ...
    public NoEntityFoundExceptionGenerator(final GeneratorOptions generatorOptions, final MetaEntity metaEntity, final String outputPath) {
    ...
    public void generate() throws IOException {
        ...
        try {
            final String filename = "No" + this.metaEntity.getName() + "FoundException";
